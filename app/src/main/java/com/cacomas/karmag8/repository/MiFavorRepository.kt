            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (childDataSnapshot in dataSnapshot.children) {
                    ...
                    if(favor.user==currentUser) {
                        database.child("Mifavor").child(childDataSnapshot.key.toString())
                    ...
                    if (favor.terminado1=="1" && favor.terminado2=="1"){
                        ...
                        database.child("Mifavor").child(childDataSnapshot.key.toString()).removeValue()
                ...
                for (childDataSnapshot in dataSnapshot.children) {
                    ...
                    if(user==karma.user){
                        if (sw=="1") {
                            ...
                            database.child("Karma").child(childDataSnapshot.key.toString())
